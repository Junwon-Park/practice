...
class GlobalConfigPrototype extends ConfigPrototype {
  ...
  get MONGODB_HOST(): string {
    return this.getString('MONGODB_HOST', 'Unknown');
  }
  get MONGODB_CONNECTIONNAME(): string {
    return this.getString('MONGODB_CONNECTIONNAME', 'Unknown');
  }
  get APP_NAME(): string {
  ...
  get SERVER_PORT(): number {
    return this.getNumber('SERVER_PORT', 8080);
  }
  get SWAGGER_ENABLED(): boolean {
