...
export const ObjectIdToString = (id?: ObjectId): Nullable<string> =>
  id?.toHexString() || null;
export const ObjectIdsToStrings = (ids?: ObjectId[]): Nullable<string[]> =>
  ids?.map((id) => id.toHexString()) || null;
